            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="form-group row">
                        ...
                        <select name="activeMenu" id="activeMenu" class="form-control" hidden>
                            <option value="kompen_tersedia"></option>
                        </select>
                    </div>
                </div>
            </div>
...
@push('js')
    <script>
        ...
        var dataKompenSelesai;
        $(document).ready(function(){
            dataKompenSelesai = $('#table_kompen').DataTable({
                processing: true,
                //serverSide: true, jika ingin menggunakan server side processing
                serverSide: true,
                ajax:{
                    "url": "{{ url('kompen_selesai/list') }}",
                    "dataType": "json",
                    "type": "POST",
                    "data": function (d){
