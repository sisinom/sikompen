...
@else
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input value="{{ $kompetensi->deskripsi_kompetensi }}" type="text" name="deskripsi_kompetensi" id="deskripsi_kompetensi"
                            class="form-control" required>
    ...
    <script>
        $(document).ready(function() {
            $("#form-edit").validate({
                rules: {
                    nama_kompetensi: { required: true, minlength:3, maxlength: 30 },
                    deskripsi_kompetensi: { required: true, minlength: 3, maxlength: 255 }
                },
