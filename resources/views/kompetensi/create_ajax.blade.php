        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <input value="" type="text" name="nama_kompetensi" id="nama_kompetensi" class="form-control" required>
                    <small id="error-nama_kompetensi" class="error-text form-text text-danger"></small>
                </div>
                <div class="form-group">
                    <label>Deskripsi</label>
                    <input value="" type="text" name="deskripsi_kompetensi" id="deskripsi_kompetensi" class="form-control" required>
